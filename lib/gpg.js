...
var GPG = {
  ...
  /**
   * Set the preferred promise library (default is native).
   *
   * @param  {Module} promiseLib The promise library to use
   */
  setPromise: function(promiseLib) {
    spawnGPG.Promise = promiseLib;
    return GPG;
  },
  ...
  callStreaming: function(inputFileName, outputFileName, args, fn) {
    return spawnGPG.streaming({source: inputFileName, dest: outputFileName}, args, fn);
  },
  ...
  encryptToFile: function (options, fn){
    return spawnGPG.streaming(options, ['--encrypt'], fn);
  },
  ...
  encryptFile: function(file, fn){
    ...
    return new spawnGPG.Promise(function (resolve, reject) {
      fn = spawnGPG.defaultCallback(fn, resolve, reject);
  ...
  encrypt: function(str, args, fn){
    return spawnGPG(str, ['--encrypt'], args, fn);
  },
  ...
  decrypt: function(str, args, fn){
    return spawnGPG(str, ['--decrypt'], args, fn);
  },
  ...
  decryptToFile: function (options, fn){
    return spawnGPG.streaming(options, ['--decrypt'], fn);
  },
  ...
  clearsign: function(str, args, fn){
    return spawnGPG(str, ['--clearsign'], args, fn);
  },
  ...
  verifySignature: function(str, args, fn){
    ...
    return spawnGPG(str, defaultArgs, args, fn);
  },
  ...
  removeKey: function(keyID, args, fn){
    ...
    return spawnGPG(keyID, defaultArgs, args, fn);
  }
