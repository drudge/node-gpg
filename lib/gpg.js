...
var GPG = {
  ...
  /**
   * Decrypt string `str` and pass the decrypted version to the callback `fn`.
   *
   * @param {String} str
  ...
  /**
   * Clearsign string `str` and pass the signed message to the callback `fn`.
   * 
   * @param {String} str
   * @param {Array} Optional additional arguments to pass to gpg
   * @param {Function} callback containing the signed message
   * @api public
   */
