...
module.exports = function(input, defaultArgs, args, cb) {
  ...
  return new module.exports.Promise(function(resolve, reject) {
    ...
    cb = defaultCallback(cb, resolve, reject);
...
// Wraps the callback function to include promise resolution handling
function defaultCallback(cb, resolve, reject) {
  // Don't reject the internal promise if using callback pattern
  if (cb) {
    reject = resolve;
  }
